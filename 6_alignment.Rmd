...
All three integration/alignment methods do a similar job of harmonizing the four sequencing techniques. Method selection, tuning and assessment is highly dependent on knowledge of the experimental design and underlying biology.

```{r final_plot, fig.height=12, fig.width=10}
CombinePlots(list(pre_cell_plot,
                  h_umap_cell_plot,
                  s_umap_cell_plot,
                  sca_umap_cell_plot),
             legend = "none",
...
CombinePlots(list(pre_tech_plot,
                  h_umap_tech_plot,
                  s_umap_tech_plot,
                  sca_umap_tech_plot),
             legend = "none",
