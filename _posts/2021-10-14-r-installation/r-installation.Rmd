...
From github:  
  ...
  - harmony (batch correction approach)
  - LaCroixColoR (pretty color palette)
...
To test the installation, run the [prerequisite Rmarkdown](https://raw.githubusercontent.com/rnabioco/cellar/master/_posts/2021-10-21-prerequisite-material/prerequiste-exercises.Rmd) which will load all of these packages.
